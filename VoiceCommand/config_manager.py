...
class ConfigManager:
    ...
    def load_settings(cls) -> Dict[str, Any]:
        ...
        try:
            ...
            # appdata에 없으면 번들에서 기본값 복사 시도
            cls._restore_default_settings(path)
    ...
    @classmethod
    def _restore_default_settings(cls, dest_path: str):
        """번들의 기본 설정 파일을 appdata로 복사 (없으면 빈 설정 생성)"""
        import sys, shutil
        ...
        logging.warning("설정 파일이 없습니다. 기본 설정을 사용합니다.")
