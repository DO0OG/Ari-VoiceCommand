...
COMPILE_TARGETS = [
    ...
    "agent/agent_math.py",
    "agent/assistant_text_utils.py",
    "agent/automation_helpers.py",
    "agent/automation_plan_utils.py",
    "agent/autonomous_executor.py",
    "agent/confirmation_manager.py",
    "agent/condition_evaluator.py",
    "agent/dag_builder.py",
    "agent/embedder.py",
    "agent/episode_memory.py",
    "agent/execution_engine.py",
    "agent/file_tools.py",
    "agent/few_shot_injector.py",
    ...
    "scripts/decision_data/build_dataset.py",
    "scripts/decision_data/generate_candidates.py",
    "scripts/decision_data/seed_data.py",
    "scripts/decision_data/expanded_data.py",
    "scripts/decision_data/gold_data.py",
    "scripts/decision_data/dataset_guards.py",
    "scripts/decision_data/split_dataset.py",
    "scripts/decision_data/train.py",
    "scripts/decision_data/evaluate.py",
    "scripts/decision_data/benchmark.py",
    "agent/mcp_client.py",
    "agent/ocr_helper.py",
    "agent/planner_json_utils.py",
    "agent/skill_installer.py",
    "agent/skill_manager.py",
    "agent/record_store.py",
    "agent/tag_keywords.py",
    ...
    "agent/verification_engine.py",
    "agent/weekly_report.py",
    "services/dom_analyser.py",
