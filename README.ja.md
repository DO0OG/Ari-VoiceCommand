...
| **エージェントスキル (SKILL.md)** | GitHub / URL / ローカルパスからスキルを導入し、要求に応じて自動でプロンプトへ注入します。 |
| **MCP 連携** | HTTPS ベースの MCP セッションを開き、組み込みツール経由でリモートツールを安全に呼び出します。 |
...
- 🧩 **[Agent Skills / MCP](./docs/USAGE.md#4-에이전트-스킬-skills--mcp)**: スキル導入、管理 UI、MCP 利用フロー
