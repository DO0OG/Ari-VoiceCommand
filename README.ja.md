...
- **親密度システム:** クリック、なでる操作、会話、1日最初の起動を蓄積して呼び方と反応を変えます。
- **頭上固定オーバーレイ UI:** 親密度 / システムモニターのオーバーレイがキャラクターの頭上に表示され、マルチモニター移動中も追従します。
- **なでる反応:** キャラクター上でマウスをゆっくり動かすと、満足リアクションと親密度上昇が発生します。
- **フォーカスアプリ反応:** コーディング、ブラウザ、動画、チャット、オフィス、ゲームなど前面アプリの種類に応じて反応します。
- **夜間の眠気モード:** 夜の時間帯にはアニメーション速度を落とし、あくびや眠そうな反応を見せます。
- **システムモニター警告:** CPU/RAM 負荷や低バッテリーに応じてクールダウン付き警告を表示します。
- **吹き出し履歴 / カスタムメッセージ:** 直近の吹き出し履歴を確認し、idle 用メッセージを自分で登録できます。
